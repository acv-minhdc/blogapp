...
Text.create!(order: 3, article: article, headline: 'Normal', sentences: ' standard dummy text ever since the 1500s')
Text.create!(order: 4, article: article, headline: 'Medium', sentences: ' when an unknown printer took a galley of type and scrambled it to make a type specimen book')
Text.create!(order: 5, article: article, headline: 'High', sentences: ' It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.')
...
Image.create!(order: 2, article: article, headline: 'light', url: 'http://i.pinimg.com/1200x/2c/35/f9/2c35f9fd3b1af75e02110892ea5c4c7c.jpg')
